...
**Описание:** Проект состоит из трех частей: АБ-тест, где необходимо проанализировать итоги эксперимента и сделать вывод, стоит ли запускать новую механику оплаты на всех пользователей; оптимизация воронки и расчет продуктовых метрик (ARPU, ARPPU, CR), а также реализовать функцию, которая будет автоматически подгружать информацию и на основании дополнительных параметров пересчитывать метрики, а также их визуализировать.<br>
**Навыки:** Считывание данных с использованием API, обработка данных, EDA, визуализация данных, проверка гипотез, тест Шапиро-Уилка, t-test, bootstrap, chi-square, расчет метрик (ARPU, ARPPU, CR).<br>
